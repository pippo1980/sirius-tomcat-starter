...
@Slf4j
public class UDPChannel implements ByteChannel, ScatteringByteChannel, GatheringByteChannel {

    protected static final StringManager sm = StringManager.getManager(UDPChannel.class);
    protected static final ByteBuffer emptyBuf = ByteBuffer.allocate(0);

    protected final SocketBufferHandler bufHandler;
    protected SocketChannel sc = null;
    protected UDPSocketWrapper socketWrapper = null;

    public UDPChannel(SocketBufferHandler bufHandler) {
     ...
     */
    public void reset(SocketChannel channel, UDPSocketWrapper wrapper) throws IOException {
        this.sc = channel;
     ...
     */
    UDPSocketWrapper getSocketWrapper() {
    ...
    static final NioChannel CLOSED_NIO_CHANNEL = new NioChannel(EMPTY) {
        @Override
        public void close() throws IOException {
        }
